      ...
      <MDBContainer fluid>
        ...
        <MDBCollapse navbar show={showBasic}>
          <MDBNavbarNav className='mr-auto mb-2 mb-lg-0'>
            ...
            <MDBNavbarItem>
              <MDBNavbarLink href='/CenterLogin'>Login</MDBNavbarLink> 
            </MDBNavbarItem>
            <MDBNavbarItem>
              <MDBNavbarLink href='/CenterRegister'>Register</MDBNavbarLink> 
            </MDBNavbarItem>
            <MDBNavbarItem>
              <MDBNavbarLink href='/CenterDashboard'>Dashboard</MDBNavbarLink> 
            </MDBNavbarItem>
            <MDBNavbarItem>
